...
Your task is to select up to 3 cards that would be most relevant and synergistic with the given deck concept. You do not _have_ to pick any cards. Results with 0, 1 or 2 selected cards are also fine. Make sure to still follow the formatting instructions in these cases. 
{format_instructions}
